...
import {
  ...
  deleteRequiredOption,
  type requiredOptionResponse,
  type PaginatedRequiredOptionResponse,
} from "../services/requiredOptionsService";
import Sidebar from "../components/SideBar";
import { useTranslation } from "react-i18next";
import { useNavigate } from "react-router-dom";
import RequiredOptionCard from "../components/RequiredOptionCard";
  ...
  useEffect(() => {
    const fetchOptions = async () => {
      try {
        ...
        showAlertMessage(
          t("dashboardScreens.requiredOptions.errorLoading"),
          t("dashboardScreens.requiredOptions.errorLoadingMessage")
        );
      } finally {
        setLoading(false);
      }
  ...
  const handleDeleteOption = async () => {
    ...
    try {
      ...
      const errorMessage =
        ...
        t("dashboardScreens.requiredOptions.errorDeletingMessage");
      showAlertMessage(
        t("dashboardScreens.requiredOptions.errorDeleting"),
        errorMessage
      );
    } finally {
    ...
    <div className="min-h-screen bg-gray-50 flex-1">
      ...
      >
            ...
            <div className="flex items-center">
              ...
              <div className="flex items-center">
                <h1 className="text-lg font-semibold text-gray-900 mr-2">
                  {t("dashboardScreens.requiredOptions.title")}
                </h1>
          ...
          {loading ? (
            ...
            <div className="flex flex-col justify-center items-center min-h-[300px] text-center px-4">
              ...
              <h2 className="text-lg font-semibold text-gray-800 mb-2">
                {t("dashboardScreens.requiredOptions.noOptions")}
              </h2>
              <button
                onClick={handleCreateOption}
        ...
        <ConfirmationModal
          ...
          title={t("dashboardScreens.requiredOptions.deleteAlert.title")}
          message={t("dashboardScreens.requiredOptions.deleteAlert.message")}
          confirmText={t("dashboardScreens.requiredOptions.deleteAlert.delete")}
          cancelText={t("dashboardScreens.requiredOptions.deleteAlert.cancel")}
        />
...
export default ListRequiredOptions;
